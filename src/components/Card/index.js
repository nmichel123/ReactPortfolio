...
function Card () {
    ...
    from the UT Austin coding boot camp, I work to create fluid websites and applications that assist people's lives and workflows.
    <br/>
    <br/>
    ...
    <a href={Resume} rel="noopener noreferrer" target="_blank" class="btn btn-primary">Link to Resume</a>
    <br />
    <br />
    </div>
    )
